...
public class Sudoku {
    ...
    public Sudoku() {
        ...
        this.colfill = new boolean[9][10];
        this.rowfill = new boolean[9][10];
    ...
    public void placeVal(int val, int row, int col) {
        ...
        this.colfill[col][val] = true;
        this.rowfill[row][val] = true;
    ...
    public void removeVal(int val, int row, int col) {
        ...
        this.colfill[col][val] = false;
        this.rowfill[row][val] = false;
        /*** UPDATE YOUR ADDITIONAL FIELDS HERE. ***/
    }

    private boolean isValid(int i, int row,int col) {
        if (this.colfill[col][i] == false && this.rowfill[row][i] == false && this.subgridHasVal[row/3][col/3][i] == false && this.valIsFixed[row][col] == false ) {
            return true;
        }
        return false;
    }
    ...
    private boolean solveRB(int n) {
        ...
        if (n == 81) {
            ...
            if (this.valIsFixed[row][col] == true) {
                ...
                for (int i = 1; i <= 9; i++ ){
                    if (this.isValid(i,row,col) == true) {
